(module
  ...
  (func $_ZN4core9panicking18panic_bounds_check17ha440f41d0e4eca5fE (type 4) (param i32 i32)
    call $_ZN4core9panicking9panic_fmt17h62f7e605cdf65d83E
    unreachable)
  (func $_ZN4core3fmt9Formatter3pad17h671c63eb2e61967cE (type 0) (param i32 i32 i32) (result i32)
  ...
  (func $_ZN5alloc3vec12Vec$LT$T$GT$17extend_from_slice17h9479b31a875bf5eeE (type 5) (param i32 i32 i32)
    ...
    i32.add
    i32.store offset=8)
  (func $_ZN44_$LT$$RF$T$u20$as$u20$core..fmt..Display$GT$3fmt17h116a3a9606a1e7d9E (type 1) (param i32 i32) (result i32)
    local.get 1
    local.get 0
    i32.load
    local.get 0
