(module
  ...
  (func $pusher (type 3) (param i32 i32)
    ...
    unreachable)
  (func $simple_format (type 1) (param i32)
    ...
    block  ;; label = @1
      ...
      block  ;; label = @2
        block  ;; label = @3
          ...
          select
          local.tee 4
          call $core::alloc::Layout::repeat::h3aeea8e44c11afb0.777
          local.get 2
          i32.load offset=4
          local.tee 5
          i32.eqz
  ...
  (func $wee_alloc::alloc_with_refill::h804521cfebfb6ccf (type 10) (param i32 i32 i32 i32 i32) (result i32)
    ...
    global.set 0
    local.get 6)
  (func $core::alloc::Layout::repeat::h3aeea8e44c11afb0.777 (type 7) (param i32 i32 i32 i32)
    (local i32 i64)
    block  ;; label = @1
      local.get 1
      local.get 2
  ...
  (func $core::ptr::real_drop_in_place::h1092d580c466569d.860 (type 1) (param i32))
